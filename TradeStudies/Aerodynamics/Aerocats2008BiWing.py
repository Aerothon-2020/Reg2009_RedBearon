...
BoxWing.LowerWing.WingWeight.AddTubeSpar("MainSpar",1.307*IN,1*IN)
BoxWing.LowerWing.WingWeight.MainSpar.SparMat.LinearForceDensity = 0.0051*LBF/IN
BoxWing.LowerWing.WingWeight.SkinMat                    = Monokote.copy()
...
BoxWing.UpperWing.WingWeight.AddTubeSpar("MainSpar",1.307*IN,1*IN)
BoxWing.UpperWing.WingWeight.MainSpar.SparMat.LinearForceDensity = 0.0051*LBF/IN
BoxWing.UpperWing.WingWeight.SkinMat                    = Monokote.copy()
...
BoxWing.EndPlate.WingWeight.AddSpar("Spar",1.307*IN,1*IN)
BoxWing.EndPlate.WingWeight.Spar.SparMat.LinearForceDensity = 0.0025*LBF/IN
